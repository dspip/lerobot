...
YAML file. Examples live in [`examples/libero_overlays/`](https://github.com/huggingface/lerobot/tree/main/examples/libero_overlays).
...
object classes. `mode: add` disables fixed init states by default (MuJoCo state
layout changes). Never edit files under the LIBERO package install.
